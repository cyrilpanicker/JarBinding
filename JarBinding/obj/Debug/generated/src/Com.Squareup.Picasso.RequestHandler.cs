...
namespace Com.Squareup.Picasso {
	...
	public abstract partial class RequestHandler : global::Java.Lang.Object {
		...
		public sealed partial class Result : global::Java.Lang.Object {
			...
			public unsafe Result (global::System.IO.Stream p0, global::Com.Squareup.Picasso.Picasso.LoadedFrom p1)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (GetType () != typeof (Result)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/io/InputStream;Lcom/squareup/picasso/Picasso$LoadedFrom;)V", __args),
								JniHandleOwnership.TransferLocalRef);
						global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Ljava/io/InputStream;Lcom/squareup/picasso/Picasso$LoadedFrom;)V", __args);
						return;
					}
					...
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_io_InputStream_Lcom_squareup_picasso_Picasso_LoadedFrom_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Ljava_io_InputStream_Lcom_squareup_picasso_Picasso_LoadedFrom_, __args);
				} finally {
			...
			public unsafe Result (global::Android.Graphics.Bitmap p0, global::Com.Squareup.Picasso.Picasso.LoadedFrom p1)
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
					return;
				...
				try {
					...
					if (GetType () != typeof (Result)) {
						SetHandle (
								global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/graphics/Bitmap;Lcom/squareup/picasso/Picasso$LoadedFrom;)V", __args),
								JniHandleOwnership.TransferLocalRef);
						global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Landroid/graphics/Bitmap;Lcom/squareup/picasso/Picasso$LoadedFrom;)V", __args);
						return;
					}
					...
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_graphics_Bitmap_Lcom_squareup_picasso_Picasso_LoadedFrom_, __args),
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Landroid_graphics_Bitmap_Lcom_squareup_picasso_Picasso_LoadedFrom_, __args);
				} finally {
				}
			}
			...
			public unsafe global::Com.Squareup.Picasso.Picasso.LoadedFrom LoadedFrom {
				...
				get {
					...
					try {
						return global::Java.Lang.Object.GetObject<global::Com.Squareup.Picasso.Picasso.LoadedFrom> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getLoadedFrom), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
			}
			...
			public unsafe global::System.IO.Stream Stream {
				...
				get {
					...
					try {
						return global::Android.Runtime.InputStreamInvoker.FromJniHandle (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getStream), JniHandleOwnership.TransferLocalRef);
					} finally {
					}
				}
			}
	...
	internal partial class RequestHandlerInvoker : RequestHandler {
		...
		public override unsafe bool CanHandleRequest (global::Com.Squareup.Picasso.Request p0)
		{
			...
			try {
				...
				__args [0] = new JValue (p0);
				bool __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_canHandleRequest_Lcom_squareup_picasso_Request_, __args);
				return __ret;
			} finally {
			}
		}
		...
		public override unsafe global::Com.Squareup.Picasso.RequestHandler.Result Load (global::Com.Squareup.Picasso.Request p0, int p1)
		{
			...
			try {
				...
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				global::Com.Squareup.Picasso.RequestHandler.Result __ret = global::Java.Lang.Object.GetObject<global::Com.Squareup.Picasso.RequestHandler.Result> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_load_Lcom_squareup_picasso_Request_I, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
