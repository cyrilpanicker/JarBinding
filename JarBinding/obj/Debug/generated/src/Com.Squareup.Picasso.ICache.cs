...
#pragma warning restore 0169
		...
		public virtual unsafe void ClearKeyUri (string p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "clearKeyUri", "(Ljava/lang/String;)V"), __args);
			} finally {
		...
		public virtual unsafe int MaxSize ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualIntMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "maxSize", "()I"));
			} finally {
			}
		}
...
#pragma warning restore 0169
	...
	public partial interface ICache : IJavaObject {
		...
		[Register ("clear", "()V", "GetClearHandler:Com.Squareup.Picasso.ICacheInvoker, JarBinding")]
		void Clear ();
		...
		[Register ("clearKeyUri", "(Ljava/lang/String;)V", "GetClearKeyUri_Ljava_lang_String_Handler:Com.Squareup.Picasso.ICacheInvoker, JarBinding")]
		...
		[Register ("get", "(Ljava/lang/String;)Landroid/graphics/Bitmap;", "GetGet_Ljava_lang_String_Handler:Com.Squareup.Picasso.ICacheInvoker, JarBinding")]
		...
		[Register ("maxSize", "()I", "GetMaxSizeHandler:Com.Squareup.Picasso.ICacheInvoker, JarBinding")]
		int MaxSize ();
		...
		[Register ("set", "(Ljava/lang/String;Landroid/graphics/Bitmap;)V", "GetSet_Ljava_lang_String_Landroid_graphics_Bitmap_Handler:Com.Squareup.Picasso.ICacheInvoker, JarBinding")]
		...
		[Register ("size", "()I", "GetSizeHandler:Com.Squareup.Picasso.ICacheInvoker, JarBinding")]
		int Size ();
